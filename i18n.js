...
const APP_VERSION_FALLBACK = '2.6.12';
...
const I18N_MESSAGES = {
    ja: {
        ...
        'role.admin': '管理者',
        'role.staff': '一般職員',
        'role.importStaff': '導入職員',
        'role.newEmployee': '新入社員',
        'envKind.社内': '社内',
        'envKind.本番': '本番',
        'envPurpose.生産': '生産',
        'envPurpose.開発': '開発',
        'envPurpose.テスト': 'テスト',
        'envPurpose.受入': '受入',
        'placeholder.tagsExample': 'タグ1, タグ2',
        'default.envName': '新規環境',
        'default.productionEnvName': '新規本番環境',
        'suffix.copy': 'コピー',
        'kana.other': 'その他',
        'section.envInfo': '環境情報',
        'section.apRdp': 'AP RDP情報',
        'section.dbRdpInfo': 'DB RDP情報',
        'section.db': '▼ データベース情報',
        'section.rdp': '▼ サーバ情報',
        'section.rdpPlain': 'サーバ情報',
        ...
        'serverName.apRdp': 'AP RDP情報',
        'serverName.dbRdp': 'DB RDP情報',
        'serverName.shared': 'AP/DB共用',
        'serverName.bastion': '踏み台',
        'serverName.server': 'サーバ情報',
        'modal.add': '追加',
        'modal.orgAdd': '組織追加',
        'modal.orgEdit': '組織編集',
        ...
        'status.platform': 'プラットフォーム',
        'status.server': 'サーバー',
        'status.http': 'HTTP {status}',
        'status.basicCheck': '基本確認',
        'status.guess': '推測',
        'status.osGuess': 'OS推測',
        'status.ttl': 'TTL {ttl}',
    ...
    zh: {
        ...
        'app.productionTitle': '生产环境',
        'app.productionAdminTitle': '生产环境数据管理',
        ...
        'role.admin': '管理员',
        'role.staff': '一般职员',
        'role.importStaff': '导入职员',
        'role.newEmployee': '新员工',
        'envKind.社内': '社内',
        'envKind.本番': '本番',
        'envPurpose.生産': '生产',
        'envPurpose.開発': '开发',
        'envPurpose.テスト': '测试',
        'envPurpose.受入': '受入',
        'placeholder.tagsExample': 'tag1, tag2',
        'default.envName': '新增环境',
        'default.productionEnvName': '新增生产环境',
        'suffix.copy': 'Copy',
        'kana.other': '其他',
        'section.envInfo': '环境信息',
        'section.apRdp': 'AP RDP信息',
        'section.dbRdpInfo': 'DB RDP信息',
        'section.db': '▼ 数据库信息',
        'section.rdp': '▼ 服务器信息',
        'section.rdpPlain': '服务器信息',
        'section.dbRdp': '▼ DB服务器信息',
        'section.productionVpn': 'VPN',
        'section.productionBastion': '跳板机',
        'section.productionAp': 'AP',
        'section.productionDb': 'DB',
        'serverName.apRdp': 'AP RDP信息',
        'serverName.dbRdp': 'DB RDP信息',
        'serverName.shared': 'AP/DB共用',
        'serverName.bastion': '跳板机',
        'serverName.server': '服务器信息',
        'modal.add': '追加',
        'modal.orgAdd': '机构追加',
        'modal.orgEdit': '机构编辑',
